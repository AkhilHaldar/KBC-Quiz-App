...
questions = ["Which team won the ‘Twenty20 World Cup title 2022’?",
             "Who has won the ICC Player of the Month Award for October 2022??",
             "Who has been named the Captain of the Indian team for the upcoming T20I series in New Zealand?",
             "Which team won the Road Safety World Series T20 2022?",
...
first_option = ["India", "Rohit Sharma",
                "Rishab Pant", "Sri Lanka Legends",
                "One Piece", "Akira Toriyama",
                "Windows 7", "Elephant", "11:23PM", "KKR",
                "Earth", "8",
                "100 years", "Google", "Monty Ritz"]

second_option = ["Pakistan", "Surya Kumar Yadav",
                 "Shikhar Dhawan", "India Legends",
                 "Digimon", "Satoshi Tajiri",
                 "Linux", "Lion", "11.11PM", "CSK",
                 "Uranus", "5",
                 "50 years",
                 "Microsoft", "Danis Lio"]

third_option = ["Australia", "KL Rahul",
                "Rohit Sharma", "Bangladesh Legends",
                "Cowboy Bebop", "Hirohiko Arak",
                "Mac", "Tiger", "7:23PM", "MI",
                "Mars", "7",
                "500 years",
                "Amazon", "Bill Gates"]

fourth_option = ["England", "Virat Kohli",
                 "Hardik Pandya", "Australia Legends",
                 "Pokemon", "Hayao Miyazak",
...
correct_answers = ["England", "Virat Kohli", "Hardik Pandya", "India Legends", "Pokemon", "Akira Toriyama",
...
centreImage = PhotoImage(file='img-removebg-preview.png')
